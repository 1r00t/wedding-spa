...
<svelte:head>
	<title>Hochzeitsfotos von Jule & Nici</title>
</svelte:head>

<header
	class="fixed top-0 z-10 flex h-16 w-full items-center justify-between bg-stone-600/80 pr-10 text-stone-300 backdrop-blur-lg"
>
...
<style global lang="postcss">
	body {
		...
		background-image: linear-gradient(transparent, #f5f5f4 75vh),
